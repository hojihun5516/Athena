...
All Athena forums and spaces are meant for professional interactions, and any behavior which could reasonably be considered inappropriate in a professional setting is unacceptable.
...
This Code of Conduct applies to all content on Athena’s GitHub organization, or any other official Athena web presence allowing for community interactions, as well as at all official Athena events, whether offline or online.

The Code of Conduct also applies within project spaces and in public spaces whenever an individual is representing Athena or its community. Examples of representing a project or community include using an official project e-mail address, posting via an official social media account, or acting as an appointed or de facto representative at an online or offline event. 
